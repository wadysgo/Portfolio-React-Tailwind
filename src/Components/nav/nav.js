...
export function Nav() {
    return (
        <>
            <header>
                <nav className='w-full h-16 flex justify-center items-center text-center
                ...
                '>
                    <ul className='sm:w-full text-center
                    cl:w-full cl:h-full cl:text-center
                   
                    '>
                        <li className='text-white text-sm text-center
                        ...
                        '>
                            <a href='#inicio' className='m-5 sombraTexto cl:text-center
                            cl:w-72 cl:m-1 cl:mb-5 cl:bg-orange-500 cl:pt-2 cl:pb-2 cl:rounded-full cl:pl-24 cl:pr-24
                            ...
                            cl:w-72 cl:m-1 cl:mt-5 cl:mb-5 cl:bg-orange-500 cl:pt-2 cl:pb-2 cl:rounded-full cl:pl-24 cl:pr-24
                            sm:m-4 sm:bg-orange-500 sm:w-5/6 sm:pt-2 sm:pb-2 sm:rounded-full
                            lg:bg-transparent lg:mr-0 lg:ml-0 lg:text-sm lg:p-2
                            '>Sobre Mi</a>

                            <a href='#tecnologias' className='m-5 sombraTexto cl:text-center
                            cl:w-72 cl:m-1 cl:mt-5 cl:mb-5 cl:bg-orange-500 cl:pt-2 cl:pb-2 cl:rounded-full cl:pl-24 cl:pr-24
                            sm:m-4 sm:bg-orange-500 sm:w-5/6 sm:pt-2 sm:pb-2 sm:rounded-full 
                            lg:bg-transparent lg:mr-0 lg:ml-0 lg:text-sm lg:p-2 
                            '>Habilidades</a>
